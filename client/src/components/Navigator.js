...
import logo from './imgs/RoundtableLogoDark.png'
...
const styles = theme => ({
  ...
  item: {
    ...
    '&:hover,&:focus': {
      backgroundColor: '#4287f5' //blue select
    }
  },
  itemCategory: {
    backgroundColor: '#262525', //black background
    boxShadow: '0 -1px 0 #4287f5 inset', //blue border
    paddingTop: theme.spacing(2),
    paddingBottom: theme.spacing(2)
  },
  firebase: {
